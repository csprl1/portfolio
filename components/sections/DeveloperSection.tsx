...
const cards = [
  { icon: Globe, title: "Frontend", tech: "React, Next.js, Vue, Vite, TypeScript" },
    ...
    <section className="relative py-20 sm:py-32 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto relative">
        ...
        <div
          ...
          w-[320px] h-[320px] sm:w-[620px] sm:h-[620px]
          bg-accent/10 blur-[100px] sm:blur-[140px]
          rounded-full pointer-events-none"
        />
        ...
        >
          <p className="text-accent tracking-[0.25em] text-[11px] sm:text-xs mb-3 sm:mb-4">
            01 — DEVELOPER
          </p>
          ...
          <div className="w-12 sm:w-16 h-px bg-accent/40 my-4 sm:my-6" />
        ...
        >
          <h3 className="text-base sm:text-lg font-semibold mb-6 sm:mb-10">
            Featured <span className="text-accent">Projects</span>
          </h3>
    ...
    tech: ["Three.js", "WebGL", "TypeScript", "Linear Algebra"],
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="text-accent/70 text-xs sm:text-sm">
                    {project.id}
                  </span>
                ...
                <div className="flex sm:hidden gap-2 overflow-x-auto scrollbar-hide">
                  {project.tech.map((tech) => (
                    <span key={tech} className="text-[11px] px-3 py-1 rounded-full bg-white/5 border border-white/10 whitespace-nowrap">
                      {tech}
                    </span>
                  ))}
                </div>

                {/* Desktop Tags untouched */}
                <div className="hidden sm:flex gap-2">
                  {project.tech.map((tech) => (
          ...
          <div className="mt-8 sm:mt-10 text-center">
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
              <Link
                href="/developer"
                className="text-accent text-[11px] sm:text-xs tracking-[0.25em]"
              >
                VIEW ALL PROJECTS ↗
              </Link>
            </motion.div>
